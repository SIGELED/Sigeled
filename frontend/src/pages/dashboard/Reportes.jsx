...
const Reportes = () => {
  ...
  // Query para estadísticas de contratos
  ...
  // Query para estadísticas de títulos
  ...
  // Query para ranking de antigüedad
  ...
  // Query para contratos próximos a vencer
  ...
  // Query para listado de docentes
  ...
  // Preparar datos para gráfico de títulos
    ...
    <div className="min-h-screen bg-[#020c14] text-white p-6 pt-20">
      <div className="max-w-7xl mx-auto space-y-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {/* Gráfico de Contratos por Período */}
          ...
          {/* Gráfico de Títulos por Tipo */}
          <div className="bg-[#101922] rounded-lg p-6">
            <h2 className="text-xl font-semibold mb-4">Títulos por Tipo</h2>
            {loadingTitulos ? (
              <div className="h-64 flex items-center justify-center">
                <div className="animate-spin rounded-full h-8 w-8 border-b-2 border-[#19F124]"></div>
              </div>
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-700">
                    ...
                    <th className="text-left py-3 px-4">Primer Contrato</th>
                    <th className="text-left py-3 px-4">Antigüedad</th>
                    <th className="text-left py-3 px-4">Contratos</th>
                ...
                <tbody>
                  {rankingAntiguedad?.map((docente, index) => (
                    <tr key={docente.id_persona} className="border-b border-gray-800 hover:bg-[#1a2532] transition-colors">
                      ...
                      <td className="py-3 px-4">{docente.apellido}, {docente.nombre}</td>
                      <td className="py-3 px-4">{docente.dni}</td>
                      <td className="py-3 px-4">{new Date(docente.fecha_inicio).toLocaleDateString('es-AR')}</td>
                      ...
                      <td className="py-3 px-4">
                        ...
                        <span className="text-gray-400 ml-1">({docente.contratos_activos} activos)</span>
                      </td>
                      <td className="py-3 px-4">
                        <button
                          onClick={() => handleDescargarInforme(docente.id_persona, docente.apellido, docente.nombre)}
                          className="flex items-center gap-1 px-3 py-1 bg-[#19F124] text-[#020c14] rounded hover:bg-[#3af743] transition-colors text-sm"
                        >
        ...
        <div className="bg-[#101922] rounded-lg p-6">
          ...
          {loadingVencer ? (
              ...
              <table className="w-full">
                <thead>
                  <tr className="border-b border-gray-700">
                    ...
                    <th className="text-left py-3 px-4">Vence</th>
                    <th className="text-left py-3 px-4">Días Restantes</th>
                    <th className="text-left py-3 px-4">Materias</th>
                  </tr>
                </thead>
                <tbody>
                  {contratosVencer.map((contrato) => (
                    <tr key={contrato.id_contrato_profesor} className="border-b border-gray-800 hover:bg-[#1a2532] transition-colors">
                      <td className="py-3 px-4">{contrato.apellido}, {contrato.nombre}</td>
                      <td className="py-3 px-4">{contrato.dni}</td>
                      <td className="py-3 px-4">{contrato.periodo} {contrato.anio}</td>
                      <td className="py-3 px-4">{new Date(contrato.fecha_fin).toLocaleDateString('es-AR')}</td>
                      <td className="py-3 px-4">
            ...
            <p className="text-gray-400 text-center py-8">No hay contratos próximos a vencer en los próximos {diasVencimiento} días</p>
          )}
        </div>

        {/* Búsqueda y Descarga de Informes Escalafonarios */}
        <div className="bg-[#101922] rounded-lg p-6">
          <div className="flex items-center gap-2 mb-4">
              ...
              <table className="w-full">
                <thead className="sticky top-0 bg-[#101922]">
                  <tr className="border-b border-gray-700">
                    ...
                    <th className="text-left py-3 px-4">Títulos</th>
                    <th className="text-left py-3 px-4">Contratos</th>
                    <th className="text-left py-3 px-4">Antigüedad</th>
                    <th className="text-left py-3 px-4">Acciones</th>
                  </tr>
                ...
                <tbody>
                  {listadoDocentes.map((docente) => (
                    <tr key={docente.id_persona} className="border-b border-gray-800 hover:bg-[#1a2532] transition-colors">
                      <td className="py-3 px-4">{docente.apellido}, {docente.nombre}</td>
                      <td className="py-3 px-4">{docente.dni}</td>
                      <td className="py-3 px-4 text-sm text-gray-400">{docente.email || 'N/A'}</td>
                      <td className="py-3 px-4 text-center">{docente.total_titulos}</td>
                      <td className="py-3 px-4 text-center">
                        {docente.total_contratos} 
                        <span className="text-gray-400 ml-1">({docente.contratos_activos} activos)</span>
                      </td>
                      <td className="py-3 px-4 text-center">{docente.antiguedad_anios || 0} años</td>
                      <td className="py-3 px-4">
                        <button
                          onClick={() => handleDescargarInforme(docente.id_persona, docente.apellido, docente.nombre)}
                          className="flex items-center gap-1 px-3 py-1 bg-[#19F124] text-[#020c14] rounded hover:bg-[#3af743] transition-colors text-sm"
