...
import { FiUploadCloud, FiCheck, FiAlertCircle, FiFileText, FiX } from "react-icons/fi";
...
export default function RegisterTitulo({ idPersona, onBack, onFinish, onDraftChange, saving }) {
    ...
    }, [id_tipo_titulo, nombre_titulo, institucion, fecha_emision, matricula_prof, id_archivo, onDraftChange]);
    ...
    const handleDrop = async (file) => {
        try {
            ...
            const _id = up?.data?.archivo?.id_archivo ?? up?.data?.id_archivo ?? null;
    ...
    return (
        ...
        <h3 className="pt-2 pl-5 pr-5 mb-5 text-3xl font-semibold text-white">Completá los datos sobre tu título</h3>
        ...
        <div className="flex justify-between mt-6">
            ...
            title={uploadState === "uploading" ? "Esperá a que termine la subida" : undefined}
            >
