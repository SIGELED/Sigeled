...
import { FiZoomIn, FiZoomOut, FiDownload, FiRefreshCw, FiMaximize2, FiMinimize2 } from "react-icons/fi";
...
export default function PdfPreviewModal({ url, title, onClose }) {
        ...
        loadingTask.promise
            ...
            .catch(err => {
                ...
                if (err?.message?.includes('Loading aborted')) {
                    console.debug('Carga de PDF abortada (modo dev / StrictMode).');
                    return;
                }
    ...
    }, [pdfDoc, pageCount, scale, rotation]);
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-90">
            ...
            <div
                className={
                    `relative z-10 flex flex-col bg-[#101922] shadow-2xl overflow-hidden transition-all duration-200
                    ${isFullScreen
            ...
            >
                        ...
                        <div className="flex items-center justify-center w-full h-full">
                            <div className="w-full max-w-md p-6 text-center border bg-red-900/20 rounded-xl border-red-500/30">
                                ...
                                <p className="mt-2 text-sm text-gray-400">
                                    Es posible que el archivo esté dañado o la URL haya expirado.
                                </p>
                            </div>
                        </div>
                    )}
                ...
                {pageCount > 0 && (
                    <div className="px-6 py-3 bg-[#0b1420] border-t border-[#1b2a37] flex items-center justify-between text-xs text-gray-400">
                        ...
                        <span className="hidden sm:inline">
                            Desplazate con el scroll para navegar entre páginas.
                        </span>
                    </div>
                )}
            </div>
