...
legajoRouter.post('/:id_persona/estado', verificarToken, soloAdministrador, asignarEstadoManual);

legajoRouter.post('/:id_persona/plazo', verificarToken, soloAdministrador, asignarPlazoGracia);
